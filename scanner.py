...
def main():
    ...
    report_writer.write_report_short(data_list=found_security_headers,
                                     desc_str="These are the security headers found in target:", color="green")
    print()
    report_writer.write_report(data_list=missing_headers, desc_str="These are the missing headers in target",
                               color="red")
    print()
    report_writer.write_report(data_list=deprecated_headers,
                               desc_str="These headers are deprecated, and should no longer be used", color="yellow")
